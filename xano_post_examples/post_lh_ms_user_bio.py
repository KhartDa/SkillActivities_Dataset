...
payload = {
    ...
    "formal_education": "example_value",  # text
    "professional_experience": "example_value",  # text
    "linkedin": "example_value",  # text
    "website": "example_value",  # text
}

url = f"{base_url}/tables/lh_ms_user_bio"
