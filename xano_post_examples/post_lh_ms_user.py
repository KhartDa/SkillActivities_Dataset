...
payload = {
    ...
    "account_id": "example_value",  # integer
    "role": "example_value",  # enum
    "password_reset": {
        "token": "example_token",  # password
        "expiration": "example_expiration",  # timestamp
    },
}

url = f"{base_url}/tables/lh_ms_user"
